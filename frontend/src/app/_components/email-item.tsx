    ...
    <Card className="mb-4 p-2 bg-gray-100 rounded-md shadow">
      <Link href={`/emails/reply/${email.id}`}>
        <CardContent>
          ...
          <Typography color="text.secondary">To: {email.to}</Typography>
          <Typography color="text.secondary">CC: {email.cc}</Typography>
          <Typography color="text.secondary">BCC: {email.bcc}</Typography>
          <Typography color="text.secondary">
            Date: {date.toLocaleString("en-EN")}
          </Typography>
          <Typography color="text.secondary">Status: {email.status}</Typography>
